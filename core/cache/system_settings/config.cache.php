<?php  return array (
  ...
  'emailsender' => 'posh.studio.mail@gmail.com',
...
<p>Regards,<br />Site Administrator</p>',
  ...
  'friendly_alias_translit_class_path' => '/home/posh00/posh.pro/www/core/components/translit/model/',
  ...
  'phpthumb_nohotlink_valid_domains' => 'posh.pro',
  ...
  'phpthumb_nooffsitelink_valid_domains' => 'posh.pro',
  ...
  'pdotools_class_path' => '/home/posh00/posh.pro/www/core/components/pdotools/model/',
  'pdofetch_class_path' => '/home/posh00/posh.pro/www/core/components/pdotools/model/',
  ...
  'pdotools_elements_path' => '/home/posh00/posh.pro/www/core/elements/',
  'parser_class_path' => '/home/posh00/posh.pro/www/core/components/pdotools/model/pdotools/',
  ...
  'tiny.css_selectors' => 'OpenSansLight=mce-OpenSansLight;OpenSansBold=mce-OpenSansBold;OpenSans=mce-OpenSans;OpenSansCondensed=mce-OpenSansCondensed;OpenSansCondensedLight=mce-OpenSansCondensedLight;OpenSansCondensedBold=mce-OpenSansCondensedBold;PTSansRegular=mce-PTSansRegular;',
  'tiny.custom_buttons1' => 'undo,redo,selectall,separator,pastetext,pasteword,separator,search,replace,separator,nonbreaking,hr,charmap,separator,image,modxlink,unlink,anchor,media,separator,cleanup,removeformat,separator,fullscreen,print,code,help,fontselect,fontsizeselect',
  ...
  'tiny.theme_advanced_font_sizes' => '10px,11px,12px,13px,14px,15px,16px,17px,18px,19px,20px,21px,22px,23px,24px,25px,26px,27px,28px,29px,30px,35px,40px,45px,50px,55px,60px,70px',
  ...
  'formit.form_encryptkey' => 'modx59a6637bca68e5.07594432',
  'formit.user_name' => '',
  'formit.user_email' => '',
);